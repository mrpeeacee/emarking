...
namespace Saras.eMarking.Domain.Interfaces.RepositoryInterfaces.Standardisation
{
    public interface ITrailMarkingRepository
    {
        ...
        Task<IList<UserScriptResponseModel>> UserScriptMarking(UserScriptMarkingDetails userScriptMarkingDetails);
