...
namespace Saras.eMarking.Domain.Interfaces.RepositoryInterfaces.Project.MarkScheme
{
    public interface IMarkSchemeRepository
    {
        ...
        Task<IList<ProjectTaggedQuestionsModel>> GetQuestionsUnderProject(long projectId, int? pagenumber);
    }
}
