...
namespace Saras.eMarking.Domain.Interfaces.RepositoryInterfaces.Project.Standardisation.StdOne.TrialMarking
{
    public interface ITrialMarkingPoolRepository
    {
