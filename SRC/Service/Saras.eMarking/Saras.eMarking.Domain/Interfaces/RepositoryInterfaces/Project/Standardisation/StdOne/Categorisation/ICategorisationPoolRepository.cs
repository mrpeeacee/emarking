...
namespace Saras.eMarking.Domain.Interfaces.RepositoryInterfaces.Project.Standardisation.StdOne.Categorisation
{
    public interface ICategorisationPoolRepository
    {
        Task<List<CategorisationModel>> GetCategorisationScripts(long qigId, long projectUserRoleID, string rolecode, string searchValue="", int[] poolTypes = null);
