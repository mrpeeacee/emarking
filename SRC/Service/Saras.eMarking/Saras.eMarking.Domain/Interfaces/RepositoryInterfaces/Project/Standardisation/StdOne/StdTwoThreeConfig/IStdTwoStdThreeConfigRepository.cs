...
namespace Saras.eMarking.Domain.Interfaces.RepositoryInterfaces.Project.Standardisation.StdOne.StdTwoThreeConfig
{
    public interface IStdTwoStdThreeConfigRepository
    {
