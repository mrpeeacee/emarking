...
namespace Saras.eMarking.Domain.Interfaces.RepositoryInterfaces.AdminTools
{
    public interface IAdminToolsRepository
    {
        ...
        bool ValidateProject(long projectid, long UserId);
