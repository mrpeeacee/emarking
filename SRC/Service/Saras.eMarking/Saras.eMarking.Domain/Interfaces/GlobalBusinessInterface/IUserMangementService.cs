...
namespace Saras.eMarking.Domain.Interfaces.GlobalBusinessInterface
{
    public interface IUserMangementService
    {
        ...
        SendMailRequestModel Resetpwd(long UserId, long CurrentUserRoleId);
        
        Task<UserCreations> UserCreation(IFormFile file, long ProjectUserRoleId, int type);
        ...
        Task<SendMailRequestModel> ChangeStatusUsers(int StatusId, long UserId, long currentUserId);
