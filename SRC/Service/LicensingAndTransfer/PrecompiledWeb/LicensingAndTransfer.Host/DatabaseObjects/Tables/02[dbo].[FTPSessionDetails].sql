IF EXISTS (SELECT TOP 1 1 FROM [SYS].[OBJECTS] WHERE [OBJECT_ID] = OBJECT_ID(N'[dbo].[FTPSessionDetails]') AND [TYPE] in (N'U'))
    DROP TABLE [dbo].[FTPSessionDetails]
GO
CREATE TABLE [dbo].[FTPSessionDetails](
