...
{
    [MessageContract]
    public class CreateFTPSessionRequest
    {
        ...
        private System.Boolean LoadPackagesFromDCDToDCCField;
        public System.Boolean LoadPackagesFromDCDToDCC
        {
            get
            {
                return this.LoadPackagesFromDCDToDCCField;
            }
            set
            {
                this.LoadPackagesFromDCDToDCCField = value;
            }
        }
