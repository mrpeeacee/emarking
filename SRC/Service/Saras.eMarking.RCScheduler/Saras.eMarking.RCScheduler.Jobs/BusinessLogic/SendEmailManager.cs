...
namespace Saras.eMarking.RCScheduler.Jobs.BusinessLogic
{
    public static class SendEmailManager
    {
        ...
        public static string CallSendEmail(string triggerName, string schedulerName)
        {
            ...
            try
            {
                ApiUrl = string.Concat(ConfigurationManager.AppSettings.Get("UserSyncApiUrl"), "api/eMarking/SendEmail");
