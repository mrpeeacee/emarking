...
namespace Saras.eMarking.RCScheduler.Server
{
    ...
    public class SarasSchedulerServer : ServiceControl,ServiceShutdown,ISchedulerServer
    {
        ...
        public virtual void Initialize()
        {
            try
            {
                ...
                scheduler = Saras.Scheduler.Facade.SchedulerProviderFactory.Provider.GetScheduler();
            }
            catch (Exception e)
            {
